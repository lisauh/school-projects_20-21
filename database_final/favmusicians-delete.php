<?php
	...
	$musician_id_arr = $_POST["musician_id_arr"];
	...
	foreach($musician_id_arr as $musician_id){
		$sql = "DELETE FROM acc_favorite_musicians WHERE (account_id=$account_id AND musician_id=$musician_id)";
		if(mysqli_query($conn,$sql)){
			$output .= $musician_id.": Successfully removed from favorite musicians.<br>";
		} else {
			$output .= $musician_id.": Error removing from favorite musicians.<br>";
		}
	}
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12 text-center">
					<p><?php echo $output;?></p>
					<p><a href="favmusicians.php">Return to Favorite Musicians</a></p>
				</div>
			</div>
