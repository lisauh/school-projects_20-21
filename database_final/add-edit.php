...
<html lang="en">
	...
	<head>
		...
		<title>mmmusicdb: add/edit music</title>
	...
	<body>
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12">
					<h1>Add/Edit Music</h1>
					<p class="text-center">
						<?php
							if($_SESSION["admin"]==0){
								echo 'You do not have access to this page.';
							} else {
								echo '<a href="ae_albums.php">Add/Edit Albums</a>';
								echo '<br>';
								echo '<a href="ae_musicians.php">Add/Edit Musicians</a>';
							}
						?>
				</div>
			</div>
