<?php
	...
	$album_id_arr = $_POST["album_id_arr"];
	...
	foreach($album_id_arr as $album_id){
		$sql = "DELETE FROM acc_favorite_albums WHERE (account_id=$account_id AND album_id=$album_id)";
		if(mysqli_query($conn,$sql)){
			$output .= $album_id.": Successfully removed from favorite albums.<br>";
		} else {
			$output .= $album_id.": Error removing from favorite albums.<br>";
		}
	}
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12 text-center">
					<p><?php echo $output;?></p>
					<p><a href="favalbums.php">Return to Favorite Albums</a></p>
				</div>
			</div>
